...
2. **LP Creation**: Uniswap V4 pool is created with:
   - All accumulated `real_usdc`
   - LP reserve tokens (206,900)
3. **LP Locking**: 80% of LP tokens are locked forever
4. **Creator Reward**: 20% of LP tokens go to the token creator
5. **Hook Deployment**: Cat402Hook is attached for fee distribution

See [Graduation](/concepts/graduation) for detailed documentation.
